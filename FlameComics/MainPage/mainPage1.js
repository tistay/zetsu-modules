    ...
    let dataArrayT = [];
    let trending = document.querySelector('.pop-list-desktop').querySelectorAll('.bs');
    for(t of trending)  {
        ...
        dataArrayT.push(quickData(link, image, '', title, status));
    }
    ...
    let staffPick = document.querySelectorAll('.pop-list-desktop')[1].querySelectorAll('.bs');
    let dataArrayP = [];
    for(pick of staffPick)	{
        let image = pick.querySelector('img').getAttribute('src');
        let title = pick.querySelector('.tt').innerHTML.trim();
        let link = pick.querySelector('a').href;
    ...
    let latest = document.querySelectorAll('.bixbox')[2].querySelectorAll('.bs');
    let dataArrayL = [];

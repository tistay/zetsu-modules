    ...
    for(obj of data) {
        ...
        let update = obj.uploaded_at;
        let data = new Data(image, title, update, 'Manwha', '', '', '', false, link);
    ...
    output.push(new Output(CellDesings.wide8, Orientation.vertical, DefaultLayouts.none, Paging.none, new Section('', false), testLayout, searchArray));
